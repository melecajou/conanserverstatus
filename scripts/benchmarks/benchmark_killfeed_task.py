...
TEMP_DIR = os.path.join(PROJECT_ROOT, "temp_killfeed_task_bench")
...
async def main():
    ...
    print(f"Benchmarking kill_check_task over {len(config.SERVERS)} servers...")

    start_time = time.perf_counter()
    # Call the task function directly
    # Note: kill_check_task is a tasks.loop object, so we call its callback
